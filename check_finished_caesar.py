...
snaps = ['000','002','004','006','008','010','012','014','016','018','020','022','024','026','028','030','032','034','036','038','040','042','044','046','048','050','052','054','056','058','060','062','064','066','068','070','072','074','076','078','080','082','084','086','088','090']
...
for i in range(lim_low,lim_high):
    ...
    for snap in snaps:
        ...
        if not my_file.is_file():
            ...
            #print()
        my_file2 = Path(f"{path}/caesar_newsnaps_{snap}.hdf5")
        if not my_file.is_file():
            print(f"{path}/caesar_newsnaps_{snap}.hdf5")
            print()
